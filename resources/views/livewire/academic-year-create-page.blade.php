<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        ...
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Create Academic Year</h1>
        </div>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    <label for="is_open_for_admission"
                        class="block text-sm font-medium text-gray-700 dark:text-gray-300">Open for Admission</label>
