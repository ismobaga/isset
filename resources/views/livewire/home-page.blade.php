        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div data-aos="flip-up" class="max-w-xl mx-auto text-center mt-24">
                ...
                <p class="leading-relaxed text-gray-500 text-justify">Nos installations modernes offrent un
                    ...
                    à
                    des
                    salles de classe interactives, nous sommes déterminés à offrir la meilleure expérience
                    d'apprentissage
                    possible à nos étudiants. De plus, notre bibliothèque offre un large éventail de ressources
                    académiques
                    et
            ...
            <div class="grid md:grid-cols-3 gap-14 md:gap-5 mt-20">
                ...
                <div data-aos="fade-up" data-aos-delay="300" class="bg-white shadow-xl p-6 text-center rounded-xl">
                    ...
                    <p class="px-4 text-gray-500">Un système LMD favorisant la mobilité des étudiants au niveau
                        national et
                        international</p>
                </div>
            </div>
            ...
            <div class="mt-28">
                <div data-aos="flip-down" class="text-center max-w-screen-md mx-auto">
                    <h1 class="text-3xl font-bold mb-4">Découvrez l'Institut Supérieur d'Excellence en Santé de Touba
                        <span class="text-emerald-500">(ISEST)</span>
                    </h1>
                    <p class="text-gray-500">Au cœur de la ville sainte de Touba, l'Institut Supérieur d'Excellence en
                        Santé de
            ...
            <div class="sm:flex items-center sm:space-x-8 mt-36">
                <div data-aos="fade-right" class="sm:w-1/2 relative">
                    ...
                    <p class="py-5 lg:pr-32">Profitez d'une formation d'excellence dispensée par une équipe pédagogique
                        hautement qualifiée, composée de professeurs et de chercheurs reconnus dans leur domaine. À
                        l'ISEST,
                ...
                <div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
                    ...
                    <button
                        ...
                        <svg class="w-5 h-5 ml-1" viewBox="0 0 24 28" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M22.5751 12.8097C23.2212 13.1983 23.2212 14.135 22.5751 14.5236L1.51538 27.1891C0.848878 27.5899 5.91205e-07 27.1099 6.25202e-07 26.3321L1.73245e-06 1.00123C1.76645e-06 0.223477 0.848877 -0.256572 1.51538 0.14427L22.5751 12.8097Z"
                                fill="#2F327D" />
            ...
            <div class="md:flex mt-40 md:space-x-10 items-start">
                ...
                <div data-aos="fade-down" class="md:w-5/12 mt-20 md:mt-0 text-gray-500">
                    <h1 class="text-2xl font-semibold text-darken lg:pr-36">Un <span
                            class="text-emerald-500">personnel
                    ...
                    <div class="flex items-center space-x-5 my-5">
                        <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                            <svg class="w-4 h-4" viewBox="0 0 27 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex items-center space-x-5 my-5">
                        <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                            <svg class="w-4 h-4" viewBox="0 0 28 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="flex items-center space-x-5 my-5">
                        <div class="flex-shrink bg-white shadow-lg rounded-full p-3 flex items-center justify-center">
                            <svg class="w-4 h-4" viewBox="0 0 30 26" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="flex flex-col md:flex-row items-center md:space-x-10 mt-16">
                <div data-aos="fade-right" class="md:w-1/2 lg:pl-14">
                    ...
                    <p class="text-gray-500 my-4 lg:pr-32">Expérimentez une approche pédagogique pratique et immersive,
                        ...
                        mettre en
                        pratique les connaissances acquises en classe et d'acquérir une expérience concrète du travail
                        dans
                        le
        ...
        <div data-aos="zoom-in-left" class="md:w-6/12">
            ...
            <div class="mt-24 flex flex-col-reverse md:flex-row items-start md:space-x-10">
                <div data-aos="zoom-in-right" class="md:w-5/12">
                    ...
                    <p class="text-gray-500 my-5 lg:pr-36">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    </p>
                    <p class="text-gray-500 my-5 lg:pr-36">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    </p>
                    <p class="text-gray-500 my-5 lg:pr-36">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                    ...
                    <button
                        ...
                        <div class="border border-emerald-500 h-14 w-14 rounded-full flex items-center justify-center">
                            <svg class="w-5 h-5" viewBox="0 0 26 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                <div data-aos="zoom-in-left" class="md:w-7/12">
                    ...
                    <div
                        ...
                        <figure class="max-w-screen-md mx-auto text-center">
                            ...
                            <blockquote>
                                <p class="text-2xl italic font-medium text-gray-900 dark:text-white">Lorem ipsum dolor
                                    sit,
