<div> <!-- Add this line to wrap the content -->
    ...
    <x-slot:header>
        ...
        <div class="bg-cream">
            <div class="z-0 bacdropi w-screen h-screen inset-0 absolute"></div>
            <div class="z-20 max-w-screen-xl min-h-screen px-8 mx-auto flex flex-col lg:flex-row items-start">
                <!--Left Col-->
                <div
                    class=" z-20 flex flex-col w-full lg:w-6/12 justify-center lg:pt-24 items-start text-center lg:text-left mb-5 md:mb-0">
                    ...
                    <p data-aos="fade-down" data-aos-once="true" data-aos-delay="300"
                        class="leading-normal text-2xl mb-8 text-white font-semibold">
